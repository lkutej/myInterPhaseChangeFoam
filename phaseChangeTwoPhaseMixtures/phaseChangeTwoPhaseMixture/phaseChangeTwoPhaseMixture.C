...
:
    ...
    phaseChangeTwoPhaseMixtureCoeffs_(optionalSubDict(type + "Coeffs")) //comma removed
    //pSat_("pSat", dimPressure, lookup("pSat"))  Milad:Commented
{}
...
bool Foam::phaseChangeTwoPhaseMixture::read()
{
    if (incompressibleTwoPhaseMixture::read())
    {
        ...
        //lookup("pSat") >> pSat_; Milad:Commented
